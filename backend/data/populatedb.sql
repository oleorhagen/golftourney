...
insert into physical.hole_score (course_name, scorer_id, hole_nr, strokes)
values
('Borregaard', (select id from physical.scorer natural join physical.team where name = 'H&M'), 1, 5),
('Borregaard', (select id from physical.scorer natural join physical.team where name = 'H&M'), 2, 5),
('Borregaard', (select id from physical.scorer natural join physical.team where name = 'J&O'), 1, 5),
('Borregaard', (select id from physical.scorer natural join physical.team where name = 'J&O'), 2, 5)
;
