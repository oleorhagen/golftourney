-- Test the player public facing schema
...
select results_eq(
    'SELECT id::text, name::text, handicap::int  FROM player order by handicap',
    $$VALUES
('b885afc9-4f16-423a-b7cf-b880c99fa3f8','Juliane Skuland Karling',20),
( '626fa9fd-95ed-40e8-90f3-139ec79e79b9' , 'Ole Petter Orhagen', 24),
